...
public class MyMatchingSucController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(result==1) {
			AlertFunc.alertLocation(resp, "매칭을 수락하셨습니다.", "/ProjectMid/myPage/MyPage.do?me_num="+me_num);
		}else {
			AlertFunc.alertLocation(resp, "매칭 수락에 실패하셨습니다.", "/ProjectMid/myPage/MyPage.do?me_num="+me_num);
		}
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		dao.close();
		if(result==1) {
			AlertFunc.alertLocation(resp, "성공적으로 삭제하였습니다.", "/ProjectMid/myPage/MyPage.do?me_num="+me_num);
		}else {
			AlertFunc.alertLocation(resp, "삭제에 실패하였습니다..", "/ProjectMid/myPage/MyPage.do?me_num="+me_num);
		}
	}
}
