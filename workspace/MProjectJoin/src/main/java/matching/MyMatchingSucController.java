...
public class MyMatchingSucController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(result==1) {
			AlertFunc.alertLocation(resp, "매칭신청이 완료되었습니다.", "/ProjectMid/myPage/MyPage.do?me_num="+me_num);
		}else {
			AlertFunc.alertLocation(resp, "매칭신청이 실패했습니다.", "/ProjectMid/myPage/MyPage.do?me_num="+me_num);
		}
	}
