...
@WebServlet("/qnasBoard/qnasWrite.do")
public class QnasWriteContorller extends HttpServlet {

	
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		req.getRequestDispatcher("/07QnABoard/QnasWrite.jsp").forward(req, resp);
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		dto.setMe_num(mr.getParameter("me_num"));
		dto.setMe_name(mr.getParameter("me_name"));
		...
		//	성공 or 실패?
		if(result == 1) { //	글쓰기 성공
			resp.sendRedirect("../qnasBoard/qnasList.do");
		}
		else { //	글쓰기 실패
			resp.sendRedirect("../qnasBoard/qnasWrite.do");
		}
