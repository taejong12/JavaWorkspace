...
<link href="https://fonts.googleapis.com/css2?family=Lora:wght@600&family=Poppins&display=swap" rel="stylesheet">
...
<body>
	...
	<div style="padding: 3em 20em; margin: 5% 0em;">
		...
		<div class="form signup" class="p-3 mb-2 bg-secondary text-white">
			...
			<form name="writeFrm" method="post" action="../reviewBoard/reviewPass.do"
