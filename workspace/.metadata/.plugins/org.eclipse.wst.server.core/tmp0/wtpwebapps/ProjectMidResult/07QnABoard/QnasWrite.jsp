...
<c:if test="${sessionScope.me_id eq null}">
	<jsp:forward page="../03LoginForm/LoginForm.jsp"/>
</c:if>    
...
<jsp:include page="../common/Top.jsp"/>
	...
	<form name="writeFrm" method="post" enctype="multipart/form-data"
		action="../qnasBoard/qnasWrite.do" onsubmit="if(confirm('작성완료 하시겠습니까?')==false) return false; return validateForm(this);">
	...
	<h2>파일 첨부형 게시판 - QnA작성(Write)</h2>
		<table class="table table-bordered" style="margin:0;">
			<tr>
				...
				<td>
					<input class="form-control" type="text" name="writer" style="width:150px;" />
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input style="width:70%;" class="form-control" id="formFile" type="file" name="ofile" />
				</td>
			</tr>
			...
			<tr>
				<td colspan="2" align="center">
					...
					<button class="btn btn-outline-danger" type="reset" onclick="if( confirm('리셋하시겠습니까?') == false ) return false;">RESET</button>
