		...
		<div align="center" class="form-elements">
			...
			<div class="form-element" style="justify-content: center;">음주:
				<div style="display: flex; width: 200px; justify-content: space-evenly;">
					<div>
						<input type="radio" name="in_drunk" id="yes" value="유"/> O 				
					</div>
					<div>
						<input type="radio" name="in_drunk" id="no" value="무" /> X 			
					</div>			
				</div>
			</div>
			<hr/>
		    <div class="form-element" style="justify-content: center;">흡연:
		    	<div style="display: flex; width: 200px; justify-content: space-evenly;">
		    		<div>
						<input type="radio" name="in_smoke" id="o" value="유" /> O 		    		
		    		</div>
		    		<div>
						<input type="radio" name="in_smoke" id="x" value="무" /> X	    		
		    		</div>
				</div>
			</div>
			<hr>
