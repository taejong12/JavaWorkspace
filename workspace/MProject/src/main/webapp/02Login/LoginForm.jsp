...
<jsp:include page="../Common/Top.jsp"/>
   ...
   function validateForm(form) {
	...
	<div class="form signup" class="p-3 mb-2 bg-secondary text-white">
		...
		<form action="../Loginout/Login.do" method="post" name="LoginFrm" 
			...
			<div class="form-elements" align="center" >
				<div class="form-element" style="position: relative;">
					...
					<div class="cb">
						<input id="chkbox" type="checkbox" name="save_check" value="Y" style="height:15px;" <%= cookieCheck %> />
				 		<p class="chk-text">아이디 저장</p>
					</div>
				</div>
				<div class="form-element">
					<div>
						<input type="password" name="me_pass" placeholder="8자 이상 입력(문자/숫자/기호 사용 가능)"/>
					</div>
