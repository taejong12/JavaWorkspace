			...
			<c:otherwise>
				<c:forEach items="${boardLists}" var="list" varStatus="stat">
					<tr align="center">
						...
						<td>
							<a href="../reviewBoard/reviewView.do?num=${list.num}" style="color:black;">${list.name}</a>
						</td>
	...
	<table style="margin: auto;">
		...
		<form method="get">
			<div style="margin: auto; width: 500px;">			
				...
				<input class="form-control me-2" type="search" name="searchStr" aria-label="Search" value="${map.searchStr}" style="width:50%; display: inline;" />
