...
public class MatchingJJIMController extends HttpServlet{
		...
		protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
			...
			if(result==1) {
				AlertFunc.alertLocation(resp, "찜했습니다.", "/MProject/matching/main.do");
		...
		protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
			...
			if(result==1) {
				AlertFunc.alertLocation(resp, "해당 찜목록이 삭제되었습니다.", "/MProject/myPage/MyPage.do?me_num="+jjim_from_num);
			}else{
