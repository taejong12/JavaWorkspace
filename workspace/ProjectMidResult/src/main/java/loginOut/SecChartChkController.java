...
@WebServlet("/controller/Join3.do")
public class SecChartChkController extends HttpServlet{
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) 
		...
		if(mr == null ) {
			// 파일업로드 실패
			AlertFunc.alertLocation(resp, "첨부 파일이 제한 용량을 초과합니다.","../controller/Join3.do");
		return;
		}
		//2.파일 업로드 외 처리; ==========
		// 폼값을 DTO에 저장
...
//		원본 파일 명과 저장된 파일 이름 설정
				...
				SecChartChkDAO dao  = new SecChartChkDAO();
