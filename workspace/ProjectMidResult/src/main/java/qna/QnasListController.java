...
public class QnasListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		System.out.println(searchStr+"2");
		...
		int pageSize = 10;
		int pageBlock = 5;
		System.out.println(application.getInitParameter("PAGE_SIZE"));
		System.out.println(application.getInitParameter("PAGING_BLOCK"));
		//페이지 확인
	    int pageNum = 1;
		...
		req.getRequestDispatcher("/07QnABoard/QnasList.jsp").forward(req, resp);
