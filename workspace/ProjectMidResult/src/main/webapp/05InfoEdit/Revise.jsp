	...
	<div class="total">	
		...
		<div class="div-right">
			...
			<div class="form-element" style="width:300px;justify-content: center;">   
	    	 키: <input class="input" type="number" placeholder="키(cm)"  name="in_height"  style="margin:0; "value="${dto.in_height}"/><br /><br />
	   		</div>
	   ...
	   <div class="form-element" style="background-color:#ffeaea; border-radius: 10px; 
	     ...
	     음주여부 : <select name="in_drunk" id="renum" style="background-color:white; border-radius: 10px;">             
	            <option value="유"
	                     <c:if test="${dto.in_drunk=='유'}">selected</c:if>>유
	                </option>
	            <option value="무"
	                     <c:if test="${dto.in_drunk=='무'}">selected</c:if>>무
	                </option>
	        </select> <br/><br/></div>
	     ...
	     흡연여부 : <select name="in_smoke" id="renum" style="background-color:white; border-radius: 10px;">                 
	            <option value="유"
	                     <c:if test="${dto.in_smoke=='유'}">selected</c:if>>유
	                </option>
	            <option value="무"
	                     <c:if test="${dto.in_smoke=='무'}">selected</c:if>>무
	                </option>
	        </select> <br/><br/></div>
		...
		<div class="form-element">
	     ...
	     반려동물 유무 : <select name="in_haspet" id="renum" style="background-color:white; border-radius: 10px;">               
	      ...
	      <div class="form-element">   
	      	사진파일 : 
	        <input type="file" name="in_opic2" style="width:300px"/><img style="width:300px;" src="/ProjectMid/Storage/${dto.in_npic}"/><br/>
	      </div>
	      <div class="form-element">
	      	목소리파일 : 
