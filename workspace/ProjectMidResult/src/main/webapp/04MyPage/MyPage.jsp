      ...
      <c:choose>
         ...
         <c:when test="${list.ma_sfrom_num eq sessionScope.me_num or list.ma_sto_num eq sessionScope.me_num}">
                  <tr align="center">
                        ...
                        <td> 
                           <button type="button" id="matchingInfoBtn" class="dusfkrcjqjxms">연락처</button><br/>
                           <span id = "dusfkrcj" style="display: none;"> 
                           		<a>신청자 연락처</a> <br/>
                           		<a>카카오톡ID : ${list.ma_from_kakao }</a> <br/>
                           		<a>핸드폰 번호 : ${list.ma_from_phone }</a> <br/>
                           		<a>이메일 : ${list.ma_from_email }</a><br/>
                           		<br/>
                           		<a>대상자 연락처</a><br/>
                           		<a>카카오톡ID : ${list.ma_to_kakao }</a> <br/>
                           		<a>핸드폰 번호 : ${list.ma_to_phone }</a> <br/>
                           		<a>이메일 : ${list.ma_to_email }</a><br/>
                            </span><br/>
...
<button type="button" class="btn btn-danger" id="lastestButton" onclick="location.href='../controller/VRevise.do';">회원정보수정</button>  
<jsp:include page ="../common/Footer.jsp"/>

<script type="text/javascript" src="https://code.jquery.com/jquery-3.2.0.min.js" ></script>
<script type="text/javascript">
$(function (){
   $(".dusfkrcjqjxms").click(function (){
     $("#dusfkrcj").toggle();
  });
});
</script>
