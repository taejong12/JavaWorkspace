...
.dropdown:hover .dropdown-submenu .introBtn{
     float: left;
     width: 200px;
     font-size: 20px;
     color: gray;
...
<header>
	...
	<div id="navback" align="center">
	    <div id="nav">
			<div class="dropdown">
            <button class="dropdown-btn guide" style="padding-left: 80px;">사이트</button>
            <div class="dropdown-submenu"  >
               <a class="introBtn" href="../08Introduce/InfoPage.jsp" style="width: 100px; ">소개</a>
               <a class="introBtn" href="../01MainPage/Guide.jsp" style="width: 150px;  ">이용가이드</a>
            </div>
         </div>
